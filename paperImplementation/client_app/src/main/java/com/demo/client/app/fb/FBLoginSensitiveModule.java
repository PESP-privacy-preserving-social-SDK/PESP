...
public class FBLoginSensitiveModule extends SensitiveModule {
    private static final String TAG = FBLoginSensitiveModule.class.toString();
    private OkHttpClient client = new OkHttpClient();
    public static final MediaType JSON
            = MediaType.get("application/json; charset=utf-8");

    public FBLoginSensitiveModule(){
        client = new OkHttpClient();
    }

    @Override
    public void execute(String sensitiveInformation){
        Log.e(TAG, "FBLoginSensitiveModule modified Logging got SensitiveInformation: " + sensitiveInformation);
    ...
    @Override
    public View execute(String sensitiveInformation, Context context) {return null;}
}
